 ...
 * Für jede Klasse implementieren Sie einen Konstruktor. Das Attribut "name" soll im Code nur ein einziges
...
public class Main {
    public static void main(String[] args) {
        Maler maler = new Maler("Dali");
        Saenger saenger = new Saenger("Sting");
